...
<nav class="navbar navbar-expand-lg navbar-dark sticky-top bg-primary">
	...
	<div class="collapse navbar-collapse" id="main_nav">
		...
		<li class="nav-item dropdown">
			...
			<ul class="dropdown-menu">
				<h6 class="dropdown-header drop-header-color text-white" >CDR</h6>
				<li><a class="dropdown-item" href="formularioChamadas.php">Relatorio de Chamadas</a></li>
				<h6 class="dropdown-header drop-header-color text-white" >Gravações</h6>
				<li><a class="dropdown-item" href="formularioConsGravacao.php">Gravar Ramal </a></li>
				<li><a class="dropdown-item" href="#">Gravar Fila </a></li>
			...
			<li class="nav-item dropdown">
			<a class="nav-link  dropdown-toggle active" href="#" data-toggle="dropdown"><i class="fas fa-tachometer-alt"></i></i>&nbsp;&nbsp; Dashboard</a>
			<ul class="dropdown-menu">
				<li><a class="dropdown-item" href="status_ramais_copy.php">fila</a></li>
			</ul>
		</li>
...
<?php
    ...
    <div class="alert alert-success offset-2 w-50 dismissable">
	<button class="close" type="button" data-dismiss="alert">&times;</button>	
	<strong class="d-flex justify-content-center">Fila  <?php echo $_GET['piloto'] ;?> criada com sucesso  </strong>
	</div>
	...
	<strong class="d-flex justify-content-center">Erro ao criar a fila   <?php echo $_GET['piloto'] ;?> </strong>
	</div>
    ...
    <div class="alert alert-success offset-2 w-50 dismissable">
	<button class="close" type="button" data-dismiss="alert">&times;</button>	
	<strong class="d-flex justify-content-center">Nome da fila  <?php echo $_GET['piloto_fila'] ;?> atualizado com sucesso  </strong>
	</div>
...
<?php
    ...
    <div class="alert alert-success offset-2 w-50 dismissable">
	<button class="close" type="button" data-dismiss="alert">&times;</button>	
	<strong class="d-flex justify-content-center">Fila  <?php echo $_GET['fila'] ;?> deletada com sucesso  </strong>
	</div>
	...
	<strong class="d-flex justify-content-center">Erro ao deletar a fila  <?php echo $_GET['name'] ;?> </strong>
	</div>
...
<?php
    ...
    ?>
	 ...
	 <strong class="d-flex justify-content-center">Erro ao vincular  <?php echo $_GET['ramal_fila'] ;?> na Fila <?php echo $_GET['fila_select']?></strong>
	 </div>
...
<?php
    ...
    ?>
	 ...
	 <strong class="d-flex justify-content-center">Erro ao deletar o ramal <?php echo $_GET['ramal_fila'] ;?> da fila  <?php echo $_GET['nome_fila']?></strong>
	 </div>
...
<?php
    ...
    <div class="alert alert-success offset-2 w-50 dismissable">
	<button class="close" type="button" data-dismiss="alert">&times;</button>	
	<strong class="d-flex justify-content-center">Numero piloto <?php echo $_GET['piloto_deletado'] ;?> deletado da fila "<?php echo $_GET['fila_name']?>"</strong>
	</div>
    ...
    ?>
	 ...
	 <strong class="d-flex justify-content-center">Erro ao deletar o numero piloto <?php echo $_GET['piloto_deletado'] ;?> </strong>
	 </div>
...
<?php
    ...
    ?>
	 ...
	 <strong class="d-flex justify-content-center">Erro ao deletar o arquivo  <?php echo $_GET['arquivo_nome'] ;?> </strong>
	 </div>
...
<?php
    ...
    ?>
	 ...
	 <strong class="d-flex justify-content-center">Erro ao configurar a URA .</strong>
	 </div>
...
?>
<?php
	if (isset($_GET['gravacao_habilitada'])){  //regra sip trunk  com sucesso
		switch ($_GET['gravacao_habilitada']) {
			case "ok": // regra sip trunk  com sucesso
				?>     
    <div class="alert alert-success offset-2 w-50 dismissable">
	<button class="close" type="button" data-dismiss="alert">&times;</button>	
	<strong class="d-flex justify-content-center">Gravacao da chamada<?php echo $_GET ['exten'];?> habilitada com sucesso</strong>
	</div>
    ...
    ?>
	 <div class="alert alert-danger offset-2 w-50 dismissable">
	 <button class="close" type="button" data-dismiss="alert">&times;</button>
	 <strong class="d-flex justify-content-center">Erro ao habilitar Gravacao da chamada<?php echo $_GET ['exten'];?></strong>
...
?>
<?php
	if (isset($_GET['gravacao_desabilitada'])){  //regra sip trunk  com sucesso
		switch ($_GET['gravacao_desabilitada']) {
			case "ok": // regra sip trunk  com sucesso
				?>     
    <div class="alert alert-success offset-2 w-50 dismissable">
	<button class="close" type="button" data-dismiss="alert">&times;</button>	
	<strong class="d-flex justify-content-center">Gravacao da chamada<?php echo $_GET ['exten'];?> desabilitada com sucesso</strong>
	</div>
